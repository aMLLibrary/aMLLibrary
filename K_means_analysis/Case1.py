...
train_df_denorm = df.ix[train_indices]
test_df_denorm = df.ix[test_indices]
...
X_train_denorm = pd.DataFrame.as_matrix(train_features_denorm)
Y_train_denorm = pd.DataFrame.as_matrix(train_labels_denorm)
X_test_denorm = pd.DataFrame.as_matrix(test_features_denorm)
Y_test_denorm = pd.DataFrame.as_matrix(test_labels_denorm)
