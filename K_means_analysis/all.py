...
print('Selected features names based on minimum RSE error: ', ext_feature_names[my_best_sel])
...
data_conf['Min_RSE']['Sel_features'] = my_best_sel
data_conf['Min_RSE']['Sel_features_name'] = ext_feature_names[my_best_sel].tolist()
data_conf['Min_RSE']['Model_size'] = len(my_best_sel)
...
print('Selected features names based on classifier maximum score: ', ext_feature_names[python_best_sel])
...
data_conf['Ridge_Score']['Sel_features'] = python_best_sel
data_conf['Ridge_Score']['Sel_features_name'] = ext_feature_names[python_best_sel].tolist()
data_conf['Ridge_Score']['Model_size'] = len(python_best_sel)
...
print('Selected features names based on minimum MAPE error: ', ext_feature_names[mape_best_sel])
...
data_conf['Min_MAPE']['Sel_features'] = mape_best_sel
data_conf['Min_MAPE']['Sel_features_name'] = ext_feature_names[mape_best_sel].tolist()
data_conf['Min_MAPE']['Model_size'] = len(mape_best_sel)
