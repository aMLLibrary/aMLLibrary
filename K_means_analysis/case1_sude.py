...
def plot_histogram(run_info, result_path, degree):
    ...
    if degree > 1:
        ...
        for zero_f_idx in zero_f_idx:
            for i in range(names_list.count(zero_f_idx)):
                names_list.remove(zero_f_idx)
...
plot_histogram(run_info, result_path, degree)
