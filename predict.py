...
def main():
    ...
    parser.add_argument('-c', "--config-file",
      help="configuration file for the infrastructure", required=True)
    parser.add_argument('-r', "--regressor",
      help="binary regressor file to be used", required=True)
    parser.add_argument('-o', "--output",
      help="output file where predictions will be stored", required=True)
